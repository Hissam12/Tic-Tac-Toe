[org 0x100]
jmp start
snake: times 240 dw 0;loc in terms of r and c for each char of the snake
space: db ' '
head:db ':'
left: db 0
right:db 0
...
p:	cmp ax,[parr+bx];compares new location of head with all possible locations of poison
	jne next2
